...
namespace Source_Api.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public UserController(IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions, IUserService userService, IMemoryCache cache)
        {
        ...
        public async Task<IActionResult> RefreshToken([FromBody]RefreshTokenRequest request)
        {
            ...
            _cache.Set(newRefreshToken, user.UserName, TimeSpan.FromMinutes(60));
